...
// BOF - Zappo - ImagEngine - ONE LINE - Add ImagEngine menu entry
		$data['text_imagengine'] = $this->language->get('text_imagengine');
...
// BOF - Zappo - ImagEngine - ONE LINE - Add ImagEngine menu entry
		$data['imagengine'] = $this->url->link('design/imagengine', 'token=' . $this->session->data['token'], 'SSL');
