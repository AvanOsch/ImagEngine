...
<?php // BOF - Zappo - ImagEngine - Set a limit to number of Bestsellers and New products ?>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-bestseller-limit"><span data-toggle="tooltip" title="<?php echo $help_bestseller_limit; ?>"><?php echo $entry_bestseller_limit; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_bestseller_limit" value="<?php echo ($config_bestseller_limit) ? $config_bestseller_limit : 20; ?>" id="input-bestseller-limit" class="form-control" />
                  </div>
                </div>
                ...
                <?php } ?>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-latest-limit"><span data-toggle="tooltip" title="<?php echo $help_latest_limit; ?>"><?php echo $entry_latest_limit; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_latest_limit" value="<?php echo ($config_latest_limit) ? $config_latest_limit : 20; ?>" id="input-latest-limit" class="form-control" />
                  </div>
                </div>
                <?php if ($error_latest_limit) { ?>
                <div class="text-danger"><?php echo $error_latest_limit; ?></div>
                <?php } ?>
<?php // EOF - Zappo - ImagEngine - Set a limit to number of Bestsellers and New products ?>
              </fieldset>
              <fieldset>
...
<?php // BOF - Zappo - ImagEngine - Pass-through Image Settings ?>
              <?php foreach ($image_settings as $name => $value) { ?>
              <input type="hidden" name="<?php echo $name;?>" value="<?php echo $value;?>" />
              <?php } ?>
<?php // EOF - Zappo - ImagEngine - Pass-through Image Settings ?>
            </div>
