...
// BOF - Zappo - ImagEngine - TWO LINES - Add image Add-Ons
					$addon = $this->model_tool_image->getImageAddon($product_id, $product_info['special']);
					$image = $this->model_tool_image->resize($product_info['image'], $this->config->get('config_image_wishlist_width'), $this->config->get('config_image_wishlist_height'), $addon);
				} else {
					$image = false;
				}
